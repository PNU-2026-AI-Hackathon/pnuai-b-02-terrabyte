...
public record RegisterDeviceRequest(
    ...
    public RegisterDeviceRequest(String serialCode, String spaceName, String spaceType, BigDecimal areaSquareMeters) {
        this(serialCode, null, spaceName, spaceType, areaSquareMeters);
    }
}
