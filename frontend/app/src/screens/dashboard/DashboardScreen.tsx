...
const styles = StyleSheet.create(scaleTypography({
  ...
  serviceFlowNumber: { ...typeScale.caption, color: palette.muted, fontFamily: font, fontWeight: '700' },
  serviceFlowNumberActive: { ...typeScale.caption, color: palette.greenDark, fontFamily: font, fontWeight: '700' },
  serviceFlowLabel: { ...typeScale.cardTitle, color: palette.text, fontFamily: font },
  ...
  statLabel: { ...typeScale.cardTitle, color: palette.secondary, fontFamily: font, fontWeight: '500' },
  ...
  chartMetricButtonTextActive: { color: palette.greenDark, fontWeight: '500' },
  ...
  rangeButtonTextActive: { color: palette.greenDark, fontWeight: '500' },
