...
const styles = StyleSheet.create(scaleTypography({
  ...
  serviceFlowNumber: { ...typeScale.caption, color: palette.muted, fontFamily: font },
  serviceFlowNumberActive: { ...typeScale.caption, color: palette.greenDark, fontFamily: font },
  ...
  chartMetricButtonTextActive: { color: palette.greenDark, fontWeight: '900' },
