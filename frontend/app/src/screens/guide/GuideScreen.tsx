...
const styles = StyleSheet.create(scaleTypography({
  ...
  guideTaskTitle: { ...typeScale.cardTitle, color: palette.text, fontFamily: font, fontWeight: '500' },
  ...
  soilMaterialName: { ...typeScale.cardTitle, color: palette.text, fontFamily: font, fontWeight: '500' },
