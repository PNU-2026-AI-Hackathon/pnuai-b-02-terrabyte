...
const styles = StyleSheet.create(scaleTypography({
  ...
  cartCount: { ...typeScale.button, ...controlTextTokens.secondary, fontFamily: font },
  ...
  productName: { ...typeScale.cardTitle, color: palette.text, fontFamily: font },
  ...
  cartItemName: { ...typeScale.cardTitle, color: palette.text, fontFamily: font },
  ...
  quantityValue: { ...typeScale.label, color: palette.text, fontFamily: font, minWidth: 24, textAlign: 'center' },
