...
const styles = StyleSheet.create(scaleTypography({
  ...
  reportPlanTitle: { ...typeScale.cardTitle, color: palette.text, fontFamily: font, fontWeight: '400' },
  ...
  reportScheduleTitle: { ...typeScale.cardTitle, color: palette.text, fontFamily: font, fontWeight: '400' },
  ...
  soilRecommendationTitle: { ...typeScale.cardTitle, color: palette.text, fontFamily: font, fontWeight: '400', letterSpacing: -0.3 },
