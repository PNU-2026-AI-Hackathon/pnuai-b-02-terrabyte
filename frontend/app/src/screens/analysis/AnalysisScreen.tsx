...
const styles = StyleSheet.create(scaleTypography({
  ...
  reportFactorName: { ...typeScale.cardTitle, color: palette.text, fontFamily: font },
  ...
  reportPlanTitle: { ...typeScale.cardTitle, color: palette.text, fontFamily: font },
  ...
  reportScheduleTitle: { ...typeScale.cardTitle, color: palette.text, fontFamily: font },
  ...
  reportCropName: { ...typeScale.cardTitle, color: palette.text, fontFamily: font },
  ...
  soilRecommendationTitle: { ...typeScale.cardTitle, color: palette.text, fontFamily: font, letterSpacing: -0.3 },
