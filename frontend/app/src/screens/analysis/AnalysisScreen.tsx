...
const styles = StyleSheet.create(scaleTypography({
  ...
  reportPlanTitle: { ...typeScale.cardTitle, color: palette.text, fontFamily: font, fontWeight: '500' },
  ...
  reportScheduleTitle: { ...typeScale.cardTitle, color: palette.text, fontFamily: font, fontWeight: '500' },
  ...
  reportCropName: { ...typeScale.cardTitle, color: palette.text, fontFamily: font, fontWeight: '500' },
  ...
  soilRecommendationTitle: { ...typeScale.cardTitle, color: palette.text, fontFamily: font, fontWeight: '500', letterSpacing: -0.3 },
