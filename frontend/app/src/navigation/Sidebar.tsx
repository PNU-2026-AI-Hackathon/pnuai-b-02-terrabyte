...
const styles = StyleSheet.create(scaleTypography({
  ...
  deviceStatus: { ...typeScale.label, color: palette.greenDark, fontFamily: font },
  deviceTitle: { ...typeScale.cardTitle, color: palette.text, fontFamily: font, marginTop: 12 },
  ...
  sidebarActionText: { ...typeScale.button, color: palette.greenDark, fontFamily: font },
  sidebarActionTextMuted: { ...typeScale.button, color: palette.secondary, fontFamily: font },
