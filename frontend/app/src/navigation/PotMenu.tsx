...
const styles = StyleSheet.create(scaleTypography({
  ...
  modalTitle: { color: palette.text, fontFamily: font, fontSize: 29, fontWeight: '900', letterSpacing: -0.8, lineHeight: 37 },
  modalDescription: { color: palette.secondary, fontFamily: font, fontSize: 14, fontWeight: '600', lineHeight: 22 },
  ...
  listTitle: { color: palette.secondary, fontFamily: font, fontSize: 15, fontWeight: '900' },
  addButton: { alignItems: 'center', borderColor: palette.green, borderRadius: 9, borderWidth: 1, justifyContent: 'center', minHeight: 38, paddingHorizontal: 13 },
  addButtonText: { color: palette.greenDark, fontFamily: font, fontSize: 13, fontWeight: '900' },
  ...
  potCrop: { color: palette.muted, fontFamily: font, fontSize: 13, fontWeight: '700' },
  selectedMark: { color: palette.greenDark, fontFamily: font, fontSize: 12, fontWeight: '900' },
  editButton: { alignItems: 'center', justifyContent: 'center', minHeight: 34, paddingHorizontal: 9 },
  editButtonText: { color: palette.secondary, fontFamily: font, fontSize: 13, fontWeight: '800' },
  emptyText: { color: palette.muted, fontFamily: font, fontSize: 14, padding: 16, textAlign: 'center' },
  ...
  formTitle: { color: palette.text, fontFamily: font, fontSize: 18, fontWeight: '900' },
  formCancelText: { color: palette.secondary, fontFamily: font, fontSize: 13, fontWeight: '800' },
  formField: { gap: 8 },
  fieldLabel: { color: palette.secondary, fontFamily: font, fontSize: 13, fontWeight: '900' },
  textInput: { backgroundColor: 'rgba(255,255,255,0.42)', borderColor: palette.line, borderRadius: 9, borderWidth: 1, color: palette.text, fontFamily: font, fontSize: 15, minHeight: 44, paddingHorizontal: 12 },
  ...
  submitButton: { alignItems: 'center', backgroundColor: palette.green, borderRadius: 9, justifyContent: 'center', minHeight: 44, paddingHorizontal: 18 },
  disabledButton: { opacity: 0.55 },
  submitButtonText: { color: '#ffffff', fontFamily: font, fontSize: 14, fontWeight: '900' },
}));
