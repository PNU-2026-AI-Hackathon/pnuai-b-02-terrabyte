...
const styles = StyleSheet.create(scaleTypography({
  ...
  managerDescription: { color: palette.muted, fontFamily: font, fontSize: 13, fontWeight: '500' },
  ...
  addButtonText: { color: palette.greenDark, fontFamily: font, fontSize: 13, fontWeight: '500' },
  ...
  selectedMark: { color: palette.greenDark, fontFamily: font, fontSize: 11, fontWeight: '500' },
  potLabel: { color: palette.text, fontFamily: font, fontSize: 16, fontWeight: '500', marginTop: 4 },
  potLabelSelected: { color: palette.greenDark },
  potCrop: { color: palette.secondary, fontFamily: font, fontSize: 13, fontWeight: '500' },
  potStatus: { color: palette.muted, fontFamily: font, fontSize: 12, fontWeight: '500', marginTop: 4 },
  ...
  modalDescription: { color: palette.secondary, fontFamily: font, fontSize: 14, fontWeight: '500', lineHeight: 22 },
  ...
  closeButtonText: { color: palette.secondary, fontFamily: font, fontSize: 13, fontWeight: '500' },
  formField: { gap: 9 },
  fieldLabel: { color: palette.secondary, fontFamily: font, fontSize: 14, fontWeight: '500' },
  ...
  cropOptionText: { color: palette.secondary, fontFamily: font, fontSize: 13, fontWeight: '500' },
  cropOptionTextSelected: { color: palette.greenDark },
  errorText: { color: palette.red, fontFamily: font, fontSize: 13, fontWeight: '500' },
  ...
  cancelButtonText: { color: palette.secondary, fontFamily: font, fontSize: 14, fontWeight: '500' },
  ...
  submitButtonText: { color: '#fff', fontFamily: font, fontSize: 14, fontWeight: '500' },
}));
