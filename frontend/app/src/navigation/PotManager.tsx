...
const styles = StyleSheet.create(scaleTypography({
  ...
  managerDescription: { color: palette.muted, fontFamily: font, fontSize: 13, fontWeight: '600' },
  ...
  selectedMark: { color: palette.greenDark, fontFamily: font, fontSize: 11, fontWeight: '900' },
  potLabel: { color: palette.text, fontFamily: font, fontSize: 16, fontWeight: '900', marginTop: 4 },
  potLabelSelected: { color: palette.greenDark },
  potCrop: { color: palette.secondary, fontFamily: font, fontSize: 13, fontWeight: '700' },
  potStatus: { color: palette.muted, fontFamily: font, fontSize: 12, fontWeight: '600', marginTop: 4 },
  ...
  closeButtonText: { color: palette.secondary, fontFamily: font, fontSize: 13, fontWeight: '800' },
  formField: { gap: 9 },
  fieldLabel: { color: palette.secondary, fontFamily: font, fontSize: 14, fontWeight: '900' },
  ...
  cropOptionText: { color: palette.secondary, fontFamily: font, fontSize: 13, fontWeight: '800' },
  ...
  cancelButtonText: { color: palette.secondary, fontFamily: font, fontSize: 14, fontWeight: '800' },
  ...
  submitButtonText: { color: '#fff', fontFamily: font, fontSize: 14, fontWeight: '900' },
}));
